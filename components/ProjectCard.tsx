...
const categoryColors = {
  ...
  Games: 'bg-gradient-to-r from-purple-500 to-indigo-500 text-white',
  ...
  Lading: 'bg-gradient-to-r from-pink-500 to-rose-500 text-white',
};
...
const ProjectCard: React.FC<ProjectCardProps> = ({ project }) => {
  ...
  return (
    <div className="bg-[#0f2d47] rounded-lg overflow-hidden shadow-lg transform transition-transform duration-300 hover:scale-105 hover:shadow-[#00CED1]/20 flex flex-col border border-gray-700/50">
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div className="flex justify-between items-center mt-auto">
          {storeLink && (
            ...
            >
              {category === 'Lading' ? 'Переглянути сайт' : link.includes('play.google.com') ? 'Google Play' : 'PLAY'}
            </a>
          )}
        </div>
      </div>
