...
const projects: Project[] = [
  ...
  {
    youtubeId: 'fPAbQqN5X80',
    category: 'Lading',
    title: 'Кінематичні лендінги з відео',
    description: 'Атмосферні лендінги з видео-бекграундом, аудіо-супроводом та можливістю доната/оплати (Mono, PayPal, Stripe). Від 400$, готово за 7-10 днів. Ідеально для технологічних стартапів та мілітарі-проєктів.',
    link: 'https://www.youtube.com/watch?v=fPAbQqN5X80',
    storeLink: 'https://cheradey1.github.io/MODULAR-REMOTE-ACTUATOR-SYSTEM/#'
  },
  {
