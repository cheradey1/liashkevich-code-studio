      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row gap-12">
          ...
          <div className="md:w-1/3">
            ...
            <div className="flex items-center space-x-4 mb-4">
              <MailIcon className="h-6 w-6 text-[#00FFFF]" />
              <a href="mailto:cher.a.idey@gmail.com" className="text-gray-300 hover:text-[#00FFFF]">cher.a.idey@gmail.com</a>
            </div>
            <div className="flex items-center space-x-4 mb-6">
              <span className="text-[#00FFFF]">📱</span>
              <a href="tel:+380638371565" className="text-gray-300 hover:text-[#00FFFF]">+380 63 837 1565</a>
            </div>
          ...
          <div className="md:w-2/3">
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input type="text" name="name" id="name" value={formData.name} onChange={handleChange} className="w-full bg-[#001a3d] border border-gray-700 rounded-md py-2 px-3 text-white focus:outline-none focus:ring-2 focus:ring-[#00CED1]" />
              </div>
              <div>
                <label htmlFor="email" className="block text-sm font-medium text-gray-300 mb-2">Електронна пошта</label>
                <input type="email" name="email" id="email" value={formData.email} onChange={handleChange} className="w-full bg-[#001a3d] border border-gray-700 rounded-md py-2 px-3 text-white focus:outline-none focus:ring-2 focus:ring-[#00CED1]" />
              </div>
              <div>
                <label htmlFor="message" className="block text-sm font-medium text-gray-300 mb-2">Повідомлення</label>
                <textarea name="message" id="message" rows={5} value={formData.message} onChange={handleChange} className="w-full bg-[#001a3d] border border-gray-700 rounded-md py-2 px-3 text-white focus:outline-none focus:ring-2 focus:ring-[#00CED1]"></textarea>
              </div>
