...
const Header: React.FC<HeaderProps> = ({ scrollToSection, sections }) => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-[#001a3d]/80 backdrop-blur-sm shadow-lg' : 'bg-transparent'}`}>
      ...
      <div
        ...
        } overflow-hidden bg-[#001a3d]/95 backdrop-blur-sm`}
      >
