...
const DownloadLink: React.FC<{ href: string; icon: React.ReactNode; label: string; platform: string }> = ({ href, icon, label, platform }) => (
    <a 
      ...
      className="group bg-[#0f2d47] rounded-lg p-6 flex flex-col items-center text-center transition-all duration-300 transform hover:-translate-y-2 hover:bg-[#1a4a6f] hover:shadow-2xl hover:shadow-[#00CED1]/20 border border-gray-700/50"
    >
